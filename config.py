...
with open('data/abi/element/abi.json', 'r') as file:
    ELEMENT_ABI = json.load(file)

with open('data/abi/mintpad/abi2.json', 'r') as file:
    DEMMORTAL_ABI = json.load(file)
...
ELEMENT_CONTRACT = "0xBcFa22a36E555c507092FF16c1af4cB74B8514C8"
DEMMORTAL_CONTRACT = "0x5A77B45B6f5309b07110fe98E25A178eEe7516c1"
COOPRECORDS_CONTRACT = "0xAd626D0F8BE64076C4c27a583e3df3878874467E"
